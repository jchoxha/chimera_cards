// ╔══════════════════════════════════════════════════════════════════╗
// ║ MODULE: app/CollectionEditor — the Editor's COLLECTION page (admin tool). ║
// ║ Set which creatures and which SIZES are discovered (Codex-visible) and    ║
// ║ captured (team-assembly-pickable). Each cell cycles none → discovered →    ║
// ║ captured; bulk buttons unlock whole-roster states; reset returns the app   ║
// ║ to the fresh starter-pick state. Renders inside the Editor shell (shares   ║
// ║ its header + tab strip). Presentational: App owns the collection + saves.  ║
// ╚══════════════════════════════════════════════════════════════════╝
...
export default function CollectionEditor({ rosterEntries = [], collection, onChange, onReset, onMenu, tabs }) {
