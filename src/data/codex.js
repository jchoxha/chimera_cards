...
export const SYSTEM_INFO = [
  ...
  { name: 'Evolution', icon: 'game-icons:upgrade', desc: 'At a Campfire you can evolve a creature one size up the ladder — it permanently gains HP and Might (and the added HP heals it). Elite and Boss are terminal and can’t evolve further.' },
  { name: 'Stats', icon: 'game-icons:fist', desc: 'Each creature has five stats (from its biology + size): Might multiplies the damage it deals · Guard multiplies the Block it gains · Focus multiplies the strength of statuses/buffs it applies to OTHERS · Resolve multiplies buffs/heals it gives ITSELF and resists incoming debuffs · Speed is tempo — it draws that many extra cards per turn (Beasts/Humanoids +1, Giants −1).' },
];
