...
function mapFighter(f, includeDeck = false) {
  return {
    ...
    axes: { class: f.class ?? null, biology: f.biology ?? null, attunement: f.attunement ?? null, family: f.family ?? null, anatomy: f.anatomy ?? null, weapons: f.weapons ?? null, subtypes: f.subtypes ?? null },
